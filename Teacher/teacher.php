...
<body>
    ...
    <div class="slider">
        ...
        <a class="active" href="#"><i class="fa-solid fa-users"></i><span>Teachers</span></a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <button type="button" class="btn btn-primary" onclick="redirectToAnotherPage()">Add Teacher</button>
        ...
        <table class="table">
            ...
            <tbody>
                <?php include 'teacherDetails.php'; ?>
            </tbody>
        </table>
    </div>
    ...
    <script>
        function redirectToAnotherPage() {
            ...
            window.location.href = '/ana/Teacher/teacher_registration.php';
        }
    </script>
